...
namespace JordiBisbal.EventManager {
    ...
    public interface EventManagerInterface {
        ...
        /// <param name="listener">Listener Action to catch the event</param>
        /// <param name="target">If set, the listener will reveice the event only when target is specified on triggering the event </param>
        void StartListening(UnityEngine.Object subscriber, Enum eventName, UnityAction<object> listener, UnityEngine.Object target = null);
        ...
        /// <param name="listener">The callback to be called</param>
        /// <param name="target">If set, the listener will reveice the event only when target is specified on triggering the event</param>    
        void StartListening(Enum eventName, UnityAction<object> listener, UnityEngine.Object target = null);
        ...
        /// <param name="message">The message to be passed</param>
        /// <param name="target">If set, the listener will reveice the event only when target is specified on triggering the event</param>    
        void TriggerEvent(Enum eventName, object message = null, UnityEngine.Object target = null);
        ...
        /// <param name="eventName">The enum to use as event name</param>
        /// <param name="target">If set, the listener will reveice the event only when target is specified on triggering the event</param>    
        int ListenerCount(Enum eventName, UnityEngine.Object target = null);
        ...
        /// <param name="listener">The callback to be called</param>
        /// <param name="target">If set, the listener will reveice the event only when target is specified on triggering the event</param>    
        void TriggerEventAfter(float time, Enum eventName, object message, UnityEngine.Object target = null);
        ...
        /// <param name="eventName">Enum to use as event name</param>
        /// <param name="target">Event Target</param>
        void FlushDelayedEvents(Enum eventName, GameObject target = null);
    }
}
